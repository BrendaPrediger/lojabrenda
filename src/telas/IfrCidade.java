...
public class IfrCidade extends javax.swing.JInternalFrame {
    ...
    public IfrCidade() {
        initComponents();
        new CombosDAO().popularCombo("estado", "idestado", "descricao", jComboBox1, "");
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        ComboItem estado = (ComboItem) jComboBox1.getSelectedItem();

        cidade.setDescricao(txtNome.getText());
        cidade.setEstado_id(estado.getCodigo());
        ...
        if (codigo == 0) {
            ...
            // salvar = inserir
            retorno = new CidadeDAO().salvar(cidade);
        } else {
            // atualizar = update
            retorno = new CidadeDAO().atualizar(cidade);
        }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        new CidadeDAO().popularTabela(tblCidade, tfdCriterioPesquisa.getText());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        Cidade user = new CidadeDAO().consultarId(id);
        ...
        if (user == null) {
            ...
            txtNome.setText(String.valueOf(user.getDescricao()));
