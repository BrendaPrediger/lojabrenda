    ...
    public ArrayList<Usuario> consultarTodos() {
        ...
        try {
            ...
            while (resultadoQ.next()) {
                ...
                usuarios.setId(resultadoQ.getInt("id"));
                usuarios.setNome(resultadoQ.getString("nome"));
                usuarios.setSenha(resultadoQ.getString("senha"));
                usuarios.setSituacao(resultadoQ.getString("situacao").charAt(0));
